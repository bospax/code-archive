...
// **_ start of snippet: deploying laravel + vue application in live server _**
// **_BACK UP DATABASE, STORAGE FOLDER AND STATIC DATA FROM LIVE SERVER_**

// backup file storage
// backup file with static data
...
// configure ENV file
//  code in laravelapp/.env
APP_NAME=Laravel
APP_ENV=production
APP_KEY=base64:jTaIXUGyv/T9fMgXnQfjGYhGRQZn0JygZ40SroleCOw=
APP_DEBUG=true
APP_URL=http://rdfsedar.com/

LOG_CHANNEL=stack
LOG_LEVEL=debug

DB_CONNECTION=mysql
DB_HOST=148.72.214.239
DB_PORT=3306
DB_DATABASE=rdfsedar_laravelapp_sedar
DB_USERNAME=rdfsedar_pax
DB_PASSWORD=ZlAz$)NALKsd
...
// configure sanctum if use for authentication
// code in laravelapp/config/sanctum.php

return [
	'stateful' => explode(',', env(
		'SANCTUM_STATEFUL_DOMAINS',
		'localhost,localhost:3000,127.0.0.1,127.0.0.1:8000,::1,rdfsedar.com'
	)),
...
// configure index.php in public_html directory
// code in laravelapp/public/index.php

require **DIR**.'/core/vendor/autoload.php';
$app = require_once **DIR**.'/core/bootstrap/app.php';

// create storage symlink
// put file in laravelapp/public directory

symlink('/home/rdfsedaradmin/public_html/core/storage/app/public', '/home/rdfsedaradmin/public_html/storage');

// **_ end of snippet: deploying laravel + vue application in live server _**
```
